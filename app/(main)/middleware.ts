  ...
  const handleSavePreferences = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Attendre que la DB soit synchronisée
        console.log('⏳ Attente synchronisation DB...')
        await new Promise(resolve => setTimeout(resolve, 1500))
        
        console.log('🔄 Mise à jour de la session...')
        await update()
        
        // Petit délai supplémentaire pour la session
        await new Promise(resolve => setTimeout(resolve, 1000))
        
        console.log('🏠 Redirection directe vers /home...')
        // CHANGEMENT : Redirection directe vers /home au lieu de /preferences/success
          ...
          <button
            ...
            className={`
              ...
              ${selectedGenres.length >= 3 && !saving
                ? 'bg-gradient-to-r from-purple-600 to-red-600 hover:from-purple-500 hover:to-red-500 shadow-lg hover:shadow-xl transform hover:scale-105' 
